$(document).ready(function() {
  ...
  ********************************/
  let weatherIcon = {
    ...
    '09d': 'simple_weather_icon_11.png',
    ...
    '02n': 'simple_weather_icon_07.png',
    '03n': 'simple_weather_icon_07.png',
    '04n': 'simple_weather_icon_07.png',
    '09n': 'simple_weather_icon_32.png',
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          for (let i = 0; i < data.list.length; i++) {
            ...
            day1.setTime(data.list[i].dt * 1000)
            let dateString = day1.toUTCString()
            let date = dateString.substring(5, 16)
    ...
    let calculateAndDisplayRoute = (directionsService, directionsDisplay) => {
      directionsService.route({
        ...
        if (status === 'OK') {
          ...
          $('#viewWeather').html(`<a href="#weather"><button class="btn btn-default" id="view-weather"><img src="styles/weather/simple_weather_icon_11.png" alt="sun peeking out from behind clouds" id="weather-btn">   View Weather</button></a>`)
        }
        else {
